;; (define-module (dissoc confs nftables portknocking))

;; (define-public %ntables-portknocking
;;   "
;; # Port knocking rules
...
;;     tcp dport 333 ip  saddr . tcp dport @candidates_ipv4 add @candidates_ipv4 {ip  saddr . 54321 timeout 30s}
;;     tcp dport 54321 ip  saddr . tcp dport @candidates_ipv4 add @clients_ipv4 {ip  saddr timeout 30s} log prefix \"Successful portknock: \"
